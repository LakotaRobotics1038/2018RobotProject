...
public class SingleSwitchAuton extends Auton {
	
	private final double DIST_FROM_DS_WALL_TO_SWITCH = 11;
	private final double DIST_TO_APPROACH_SWITCH_FROM_SIDE = 1.5;
	...
	private final double DIST_TO_BACK_AWAY = .5;
	private final double DISPOSE_TIME = 1.5;
	
	/**
	 * Creates a new single switch auton
